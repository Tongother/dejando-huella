    ...
    useEffect(() => {
        ...
        async function fetchData() {
            ...
            const res = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/deletePet`, {
                ...
                body: JSON.stringify({ deleteId, especie: 1}),
            });
            if (res.ok) {
                                ...
                                <tr key={mascota.id} className="bg-white border-b">
                                    ...
                                    <td className="px-6 py-4 text-gray-700">
                                        <div className="flex items-center gap-1">
                                            <Link className="p-2  rounded-full  group transition-all duration-500  flex item-center" href={`/admin/formPets/${mascota.id}/1`}>
