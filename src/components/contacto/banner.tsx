...
//             <div className="absolute right-0 w-full md:w-[50%] h-full flex justify-center items-center bg-white opacity-50 md:opacity-50 z-10"/>
...
//                     <h1 className="text-center text-xl md:text-3xl lg:text-5xl">¡Estamos aquí para ayudarte a encontrar tu compañero de vida! <br/>
//                     Si tienes alguna pregunta o quieres saber más sobre nuestro trabajo, no dudes en escribirnos.</h1>
