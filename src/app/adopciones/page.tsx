        ...
        <FondoIconos>
          <div className="w-full lg:w-[50%] flex flex-col items-center">
            ...
            <div className="flex flex-col md:flex-row max-md:items-center md:justify-between mt-10 mb-5 w-[90%] max-sm:gap-10">
              <BotonSeleccion texto="Adopta un perrito" color="#FFB602" link="/perros" imagen={{ src:La_chona.src, width: 250, height: 260 }} />
              <BotonSeleccion texto="Adopta un gatito" color="#4C62D9" link="/gatos" imagen={{ src:Minnie.src, width: 220, height: 210 }}/>
            </div>
