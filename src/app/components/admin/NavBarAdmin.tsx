...
const NavBarAdmin = () => {
    ...
    return(
        <>
            <motion.nav className="hidden md:flex md:flex-col md:h-screen top-0 right-0 sticky bg-[#F6F6FF] font-ruby"
            initial={{
                width: 70,
            }}
            variants={{
                ...
                <div className="flex-1 flex flex-col items-center gap-4 mt-6 overflow-y-auto cajaBotones">
                    <div className="w-[90%] bg-[#FFB602] shadow-lg rounded-md ease-out duration-300 hover:scale-105">
                        <Link href="/admin">
                            <div className={`flex items-center p-4`}>
                                <Image src="/admin/hogar.png" alt="Inicio" width={30} height={30} quality={100} priority/>
                                ...
                                initial={{
                                    ...
                                    <h3 className="whitespace-nowrap ml-4">Inicio</h3>
                                </motion.div>
                            </div>
                        </Link>
                    </div>
                    ...
                    <div className="w-[90%] bg-[#FFB602] shadow-lg rounded-md ease-out duration-300 hover:scale-105">
                        <Link href="/admin">
                            <div className={`flex items-center p-4`}>
                                <Image src="/admin/dog.svg" alt="Inicio" width={30} height={30} quality={100} priority/>
                                <motion.div className="overflow-hidden flex-1"
                                initial={{
                                    width: 0,
                                }} variants={{
                                    ...
                                    <h3 className="whitespace-nowrap ml-4">Lista de animalitos</h3>
                                </motion.div>
                            </div>
                        </Link>
                    </div>
